...
<!-- this moved to lib/reln/ents.xsl so that reindexing works properly -->
<!-- don't standoff "intracerebral" in "intracerebral haemorrhage". -->
<!--<xsl:template mode="standoff" match="ent[@type='haemorrhagic_stroke']/ent[.~'^[Ii]ntra.*cerebral$']">
</xsl:template>-->
