...
public class LTGSAXReaderTest {
	static final Logger logger = Logger.getLogger(LTGSAXReaderTest.class);
	...
	public void setUp() throws Exception {
		...
		assertTrue(testReader instanceof LTGSAXReader);
	}

	@Test
	public void testParseVersion2() throws Exception {
		final String TEST_FILE = "inputPmc116581AnnotatedTest.xml";
		final File file = TestUtilities.getResourceFile(LTGSAXReaderTest.class,
				TEST_FILE);
		...
		arg1 = associatedRelation.getArgument1().getRef();
		arg2 = associatedRelation.getArgument2().getRef();
		assertTrue(arg1 instanceof Relation);
		assertTrue(arg1 == relation);
		assertTrue(arg2 instanceof Entity);
		...
		associatedRelation = associatedRelations.get(1);
		arg1 = associatedRelation.getArgument1().getRef();
		arg2 = associatedRelation.getArgument2().getRef();
		assertTrue(arg1 instanceof Entity);
		assertEquals("e942460", arg1.getId());
		assertTrue(arg2 instanceof Entity);
		assertEquals("e942456", arg2.getId());
	}
	...
	public void testParseVersion4() throws Exception {
		...
		assertTrue(firstSentence.getEndIndex() != 0);
		...
		assertEquals(3, standoffSection.getSurfaceForms().size());
	}
}
