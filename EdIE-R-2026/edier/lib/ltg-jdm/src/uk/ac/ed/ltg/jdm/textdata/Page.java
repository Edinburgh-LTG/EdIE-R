 ...
 */
public class Page extends TextElement {
	/**
	 * 
	 */
	 ...
	 *            the document
	 */
	public Page(final Document document) {
		super(document);
	 ...
	 *            the type
	 */
	public Page(final Document document, final String type) {
	 ...
	 *            the map
	 */
	public Page(final Document document, final String type, final Map map) {
	 ...
	 *            the id
	 */
	public Page(final Document document, final String id, final String type) {
	...
	public Page(final Document document, final String id, final String type,
		...
		// logger.debug("new Page(" + id + ",'" + type + "', attributes)");
	}

	public String getName() {
		return XmlElementType.PAGE.name;
	}
}