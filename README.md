...
Developed through extensive analysis and validation using Scottish brain imaging reports and expert-annotated data, EdIE-R was originally developed for and evaluated on datasets from the Edinburgh Stroke Study and NHS Tayside.

The version release here has been externally tested on radiology reports from from Generation Scotland.
